...
import { getCountToNextChar, getFirstNonWhitespaceCol, getMotionRange, getDistanceWordBackward, getDistanceWORDBackward, moveForward, moveTail } from "./myvim/motion";
